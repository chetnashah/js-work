...
An instance of this type is named `_reactInstance` in RCTCxxBridge.
...
```cpp
 private:
  ...
  std::shared_ptr<NativeToJsBridge> nativeToJsBridge_; // calls mostly forwarded to this object
  std::shared_ptr<ModuleRegistry> moduleRegistry_;
```

## Public API

Mostly forwards its calls to NativeToJSBridge.
